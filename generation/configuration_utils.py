...
class GenerationConfig(PushToHubMixin):
    ...
    def __init__(self, **kwargs):
        # Parameters that control 6-8 poems generation
        self.generate_6_8 = kwargs.pop("generate_6_8", False)
        self.rhymable_dict = kwargs.pop("rhymable_dict", None)
        self.even_ids = kwargs.pop("even_ids", None)
        self.uneven_ids = kwargs.pop("uneven_ids", None)
        self.grave_ids = kwargs.pop("grave_ids", None)
        self.unmarked_ids = kwargs.pop("unmarked_ids", None)
        self.newline_id = kwargs.pop("newline_id", None)
        self.all_ids = kwargs.pop("all_ids", None)
