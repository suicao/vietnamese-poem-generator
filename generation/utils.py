...
from .logits_process import (
    ...
    TopPLogitsWarper,
    TypicalLogitsWarper,
    UnbatchedClassifierFreeGuidanceLogitsProcessor, SixEightLogitsProcessor,
)
...
class GenerationMixin:
    ...
    def _get_logits_processor(
        ...
        if generation_config.generate_6_8:
            processors.append(SixEightLogitsProcessor(rhymable_dict=generation_config.rhymable_dict,
                                                      even_ids=generation_config.even_ids,
                                                      uneven_ids=generation_config.uneven_ids,
                                                      grave_ids=generation_config.grave_ids,
                                                      unmarked_ids=generation_config.unmarked_ids,
                                                      input_ids_seq_length=input_ids_seq_length,
                                                      newline_id=generation_config.newline_id,
                                                      all_ids=generation_config.all_ids))
